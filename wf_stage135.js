export const meta = {
  name: 'stage135-blind-buyer',
  description: '第13.5版。A37 を直した資料を、第13版と同じ盲検買い手16体に読ませる',
...
const buyers = await pipeline(JOBS, (j) =>
  agent(
    `Read the file /home/claude/work/stage135/in_buyer_${j.id}__${j.seat}.json (a JSON object).
