export const meta = {
  name: 'run12b-complete8',
  description: '残り6体を走らせて8体を揃える（Arm 1・v12.8）。it商材とΣ2枚が初めて入る',
  phases: [{ title: '生成', detail: 'E1-P2 / E2-P1 / E2-P2 / R1-P2 / R2-P1 / R2-P2 の6体（Arm 1）' }],
}
...
const JOBS = ['E1-P2', 'E2-P1', 'E2-P2', 'R1-P2', 'R2-P1', 'R2-P2']

const results = await pipeline(JOBS, (id) =>
  agent(
    `Read the file /home/claude/work/run12b/in_${id}.json (a JSON object).
