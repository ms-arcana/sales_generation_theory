...
"""
import json
from cells8_v8 import CELLS, SELLERS, TODAY

DEC = json.load(open("decisions8_v8.json", encoding="utf-8"))
...
def main():
    ...
    json.dump(out, open("prompts8_v8.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
