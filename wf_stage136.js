export const meta = {
  name: 'stage136-blind-buyer',
  description: '第13.6版。A41・A43・N₄′/R20・形式を入れた資料を、同じ盲検買い手16体に読ませる',
  phases: [{ title: '買い手', detail: 'ペルソナと資料だけを見て反応する 16体（各セル2座席）' }],
}
...
const buyers = await pipeline(JOBS, (j) =>
  agent(
    `Read the file /home/claude/work/stage136/in_buyer_${j.id}__${j.seat}.json (a JSON object).
